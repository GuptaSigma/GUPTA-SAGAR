...
I have fixed the alignment issue in the "About Me" section using a table, removed all accidental spaces in URLs (like `streamlit. app` and `domain. png`), and cleaned up the syntax errors in the Python code block.

Copy the entire block below and paste it into your `README.md`.
...
class SagarGupta:
    def __init__(self):
        ...
        self.interests = ["AI/ML", "Backend Dev", "NLP", "Data Science"]
        self.current_focus = "Building ML-powered web applications"
        self.motto = "Focused on practical projects — no fake skills"
        self.portfolio = "[https://sagar-gupta-portfolio-vhkwfkmny4zfgbn268mkgq.streamlit.app/](https://sagar-gupta-portfolio-vhkwfkmny4zfgbn268mkgq.streamlit.app/)"
...
<div align="center">
<img width="60%" src="https://www.google.com/search?q=https://github-readme-stats.vercel.app/api/top-langs/%3Fusername%3DGuptaSigma%26layout%3Dcompact%26theme%3Dtokyonight%26hide_border%3Dtrue%26langs_count%3D8" alt="Top Languages"/>
</div>

<div align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=GuptaSigma&theme=tokyo-night&hide_border=true&area=true" alt="Contribution Graph"/>
</div>
...
<a href="https://sagar-gupta-portfolio-vhkwfkmny4zfgbn268mkgq.streamlit.app/">
<img src="https://www.google.com/search?q=https://img.icons8.com/fluency/96/domain.png" width="60" alt="Portfolio"/>
